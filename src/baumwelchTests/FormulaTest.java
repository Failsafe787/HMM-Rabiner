...
class FormulaTest {
	...
	public void alphaTest() {
		...
		assertTrue(Double.compare(alphaMatrix.getValue(1, 1), 0.012074235774726142) == 0);
		assertTrue(Double.compare(alphaMatrix.getValue(2, 0), 2.2905729047711728E-4) == 0);
		assertTrue(Double.compare(alphaMatrix.getValue(2, 1), 6.861764822292593E-4) == 0);
		assertTrue(Double.compare(alphaMatrix.getValue(3, 0), 8.476917309795065E-5) == 0);
		assertTrue(Double.compare(alphaMatrix.getValue(3, 1), 4.8643065769496764E-5) == 0);
	}
	...
	public void betaTest() {
		...
		assertTrue(Double.compare(betaMatrix.getValue(2, 1), 0.14837223995102172) == 0);
		assertTrue(Double.compare(betaMatrix.getValue(1, 0), 0.008055691879161754) == 0);
